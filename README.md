...
RootMC bonded notes â€” park gold in the reserve, earn inflows, redeem as physical gold.

| Field | Value |
|-------|-------|
| **Folder / artifact** | `root-bonds` |
| **Version** | `1.7.0` |
| **Bukkit name** | `Root-Bonds` |
| **Paper API** | `26.1` |
| **Author** | Root Record |
| **Website** | https://rootmc.net |
| **Main class** | `com.rootrecord.minecraft.rootbonds.RootBondsPlugin` |

## Install

1. Install **[Root-Core](https://github.com/RootRecord/root-core)** first (license/cloud spine for the suite).
2. Download `root-bonds-1.7.0.jar` from [Releases](https://github.com/RootRecord/root-bonds/releases) or the [plugin catalog](https://rootmc.net/plugins/).
3. Remove any older `root-bonds-*.jar` from `plugins/`.
...
.\build-with-server-jdk.bat :plugins:root-bonds:jar
```
...
| Command | Description |
|---------|-------------|
| `/bonds` | Bond vault â€” issue bonds, collect coupons, redeem certificates |
...
| This plugin page | https://rootmc.net/plugins/root-bonds/ |
...
| GitHub (this repo) | https://github.com/RootRecord/root-bonds |
| Releases | https://github.com/RootRecord/root-bonds/releases |
